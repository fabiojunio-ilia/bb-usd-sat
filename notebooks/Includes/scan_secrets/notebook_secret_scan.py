...
def get_current_run_id() -> int:
    ...
    """
    try:
        # insertNewBatchRun (Utils/common) devolve o id pelo check_time exato
        # do INSERT; max(runID) aqui podia devolver o id de outra sessao
        # inserindo na mesma tabela (driver ou scanner em paralelo).
        new_run_id = insertNewBatchRun()
